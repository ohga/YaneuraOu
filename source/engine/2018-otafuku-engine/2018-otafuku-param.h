...
PARAM_DEFINE PARAM_FUTILITY_AT_PARENT_NODE_DEPTH = 6; // change
PARAM_DEFINE PARAM_FUTILITY_AT_PARENT_NODE_DEPTH2 = 7; // new 7
PARAM_DEFINE PARAM_FUTILITY_AT_PARENT_NODE_DEPTH3 = 3; // new 3
...
PARAM_DEFINE PARAM_FUTILITY_AT_PARENT_NODE_GAMMA1 = 141; // change

// depthが2乗されるので影響大きい
// 元の値 = 35
// [PARAM] min:20,max:60,step:3,interval:1,time_rate:1,fixed
//PARAM_DEFINE PARAM_FUTILITY_AT_PARENT_NODE_GAMMA2 = 51;
PARAM_DEFINE PARAM_FUTILITY_AT_PARENT_NODE_GAMMA2 = 187; // change
...
PARAM_DEFINE PARAM_PRUNING_BY_HISTORY_DEPTH = 2; // change
...
PARAM_DEFINE PARAM_IID_MARGIN_ALPHA = 256; // change
